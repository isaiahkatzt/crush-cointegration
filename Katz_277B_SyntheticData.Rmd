...
ts.plot(yt.ex1, lty = c(1:d), main="3-Dimensional I(1) Series Without Cointegration", 
        col = rainbow(d))
legend(20, -10, c("y1","y2", "y3"), lty=c(1:d), col = rainbow(d))
```
...
## cointegration test with rolling windows 
...
Clear separation in angle measurements when holding rank 1 cointegration constant; difficult to establish clear separation of regimes via angle measures when holding rank 2 cointegration constant. 
...
par(mfrow=c(1,2))
ts.plot(ex4.angle.1, main = "EX3 Angles, CI Rank 1", 
        xlab = "Window", ylab = "Angle (degrees)")
ts.plot(ex4.angle.2, main = "EX3 Angles, CI Rank 2", 
        xlab = "Window", ylab = "Angle (degrees)")
```
...
Example 3 and example 4 cointegration rank correctly determined by 91.75% and 95.88% (respectively) of all rolling windows.